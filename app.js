...
app.use('/api/v1/', UserRouter, ArticleRouter, VersionRouter, ImageRouter, OrderRouter, VersionAgentRouter, CardPaymentRouter, transactionRouter, ouvrageRouter, TransacademiaRouter, CandidateRouter, VoteRouter);
